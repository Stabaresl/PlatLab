...
function OAuthButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full flex items-center justify-center gap-2 py-2 rounded text-sm cursor-pointer border transition-all duration-150"
      style={{
...
function GitHubIcon() {
  return (
    <svg className="w-3.5 h-3.5 shrink-0" viewBox="0 0 24 24" fill="var(--text-base)">
